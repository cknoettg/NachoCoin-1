...
#   c) node1 mines 32 blocks, so now node 0 has 500000NACHO, node 1 has 4250NACHO, node2 has none.
#   d) node0 sends 601 NACHO to node2, in two transactions (301 NACHO, then 300 NACHO).
