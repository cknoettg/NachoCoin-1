...
In order to support loading of multiple wallets in nachocoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is nachocoin.cpp.
...
Changes to nachocoin.cpp
----------------------
nachocoin.cpp is the entry point into nachocoin-qt, and as such, will require some minor modifications to provide hooks for
