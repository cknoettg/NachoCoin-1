...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<nachocoin_address\> \<monthly_payment_nachocoin\> [use_ix(true|false)]
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<nachocoin_address\> \<monthly_payment_nachocoin\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` NACHO.
