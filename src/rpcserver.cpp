...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop NachoCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "NachoCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* NachoCoin features */
        {"nachocoin", "masternode", &masternode, true, true, false},
        {"nachocoin", "listmasternodes", &listmasternodes, true, true, false},
        {"nachocoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"nachocoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"nachocoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"nachocoin", "masternodedebug", &masternodedebug, true, true, false},
        {"nachocoin", "startmasternode", &startmasternode, true, true, false},
        {"nachocoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"nachocoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"nachocoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"nachocoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"nachocoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"nachocoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"nachocoin", "mnbudget", &mnbudget, true, true, false},
        {"nachocoin", "preparebudget", &preparebudget, true, true, false},
        {"nachocoin", "submitbudget", &submitbudget, true, true, false},
        {"nachocoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"nachocoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"nachocoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"nachocoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"nachocoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"nachocoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"nachocoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"nachocoin", "checkbudgets", &checkbudgets, true, true, false},
        {"nachocoin", "mnsync", &mnsync, true, true, false},
        {"nachocoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
