...
// Copyright (c) 2017-2020 The NachoCoin Coin developers
                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("NachoCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a NACHO address"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About NachoCoin Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for NachoCoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your NACHO addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_black"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified NACHO addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the NachoCoin Coin help message to get a list with possible NachoCoin Coin command-line options"));
...
void BitcoinGUI::createToolBars()
{
    if (walletFrame) {
        ...
        labelLogo->setPixmap(QIcon(":/images/nachocoin_logo_horizontal").pixmap(210, 50));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("NachoCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::message(const QString& title, const QString& message, unsigned int style, bool* ret)
{
    ...
    // Append title to "NachoCoin Coin - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
