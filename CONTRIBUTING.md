...
The following applies to code changes to the NachoCoin Core project, and is not to be
confused with overall NachoCoin Network Protocol consensus changes.
