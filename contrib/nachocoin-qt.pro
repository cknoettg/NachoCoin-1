...
SOURCES += src/activemasternode.cpp \
           ...
           src/core_write.cpp \
           src/crypter.cpp \
           src/nachocoin-cli.cpp \
           src/nachocoin-tx.cpp \
           src/nachocoin.cpp \
           src/db.cpp \
           ...
           src/qt/nachocoin.cpp \
           src/qt/nachocoinstrings.cpp \
...
RESOURCES += src/qt/nachocoin.qrc src/qt/nachocoin_locale.qrc

TRANSLATIONS += src/qt/locale/nachocoin_bg.ts \
                src/qt/locale/nachocoin_de.ts \
                src/qt/locale/nachocoin_en.ts \
                src/qt/locale/nachocoin_es.ts \
                src/qt/locale/nachocoin_fi.ts \
                src/qt/locale/nachocoin_fr.ts \
                src/qt/locale/nachocoin_it.ts \
                src/qt/locale/nachocoin_ja.ts \
                src/qt/locale/nachocoin_pl.ts \
                src/qt/locale/nachocoin_pt.ts \
                src/qt/locale/nachocoin_ru.ts \
                src/qt/locale/nachocoin_sk.ts \
                src/qt/locale/nachocoin_sv.ts \
                src/qt/locale/nachocoin_vi.ts \
                src/qt/locale/nachocoin_zh_CN.ts \
                src/qt/locale/nachocoin_zh_TW.ts
