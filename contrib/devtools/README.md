...
nachocoin/nachocoin repository.
...
Setup
---------
Configuring the github-merge tool for the NachoCoin repository is done in the following way:

    git config githubmerge.repository nachocoin/nachocoin
...
A script to optimize png files in the NachoCoin
